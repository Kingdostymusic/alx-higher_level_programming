...
In this second Alx software engineering Best School JavaScript project I dived into the infamously fu aspects of the language - scope, closures and this. I practiced working with objects and ES6-style classes.

Tests
tests: Folder of test files. Provided by Best School through the Room.
Function Prototypes 💾
